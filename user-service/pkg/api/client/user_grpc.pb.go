...
const (
	...
	UserService_DeleteProfile_FullMethodName = "/api.UserService/DeleteProfile"
	UserService_UpdateProfile_FullMethodName = "/api.UserService/UpdateProfile"
	UserService_CreateProfile_FullMethodName = "/api.UserService/CreateProfile"
)
...
func (c *userServiceClient) CreateProfile(ctx context.Context, in *CreateProfileRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedUserServiceServer) CreateProfile(context.Context, *CreateProfileRequest) (*emptypb.Empty, error) {
