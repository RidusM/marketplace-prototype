...
const (
	AuthService_SignUp_FullMethodName                = "/rbacAuth.AuthService/SignUp"
	AuthService_Verify_FullMethodName                = "/rbacAuth.AuthService/Verify"
	AuthService_SignIn_FullMethodName                = "/rbacAuth.AuthService/SignIn"
	AuthService_RefreshSession_FullMethodName        = "/rbacAuth.AuthService/RefreshSession"
	AuthService_LogOut_FullMethodName                = "/rbacAuth.AuthService/LogOut"
	AuthService_ChangePassword_FullMethodName        = "/rbacAuth.AuthService/ChangePassword"
	AuthService_ConfirmChangePassword_FullMethodName = "/rbacAuth.AuthService/ConfirmChangePassword"
	AuthService_GetUser_FullMethodName               = "/rbacAuth.AuthService/GetUser"
	AuthService_UpdateUser_FullMethodName            = "/rbacAuth.AuthService/UpdateUser"
	AuthService_DeleteUser_FullMethodName            = "/rbacAuth.AuthService/DeleteUser"
)
...
type AuthServiceClient interface {
	...
	RefreshSession(ctx context.Context, in *RefreshSessionRequest, opts ...grpc.CallOption) (*TokensResponse, error)
	LogOut(ctx context.Context, in *LogOutRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	ConfirmChangePassword(ctx context.Context, in *ConfirmChangePasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *authServiceClient) RefreshSession(ctx context.Context, in *RefreshSessionRequest, opts ...grpc.CallOption) (*TokensResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokensResponse)
...
func (c *authServiceClient) ConfirmChangePassword(ctx context.Context, in *ConfirmChangePasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AuthService_ConfirmChangePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	RefreshSession(context.Context, *RefreshSessionRequest) (*TokensResponse, error)
	LogOut(context.Context, *LogOutRequest) (*emptypb.Empty, error)
	ChangePassword(context.Context, *ChangePasswordRequest) (*emptypb.Empty, error)
	ConfirmChangePassword(context.Context, *ConfirmChangePasswordRequest) (*emptypb.Empty, error)
...
func (UnimplementedAuthServiceServer) RefreshSession(context.Context, *RefreshSessionRequest) (*TokensResponse, error) {
...
func (UnimplementedAuthServiceServer) ConfirmChangePassword(context.Context, *ConfirmChangePasswordRequest) (*emptypb.Empty, error) {
...
func _AuthService_ConfirmChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmChangePasswordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ConfirmChangePassword(ctx, req.(*ConfirmChangePasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rbacAuth.AuthService",
