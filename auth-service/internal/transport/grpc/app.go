...
import (
	...
	"gitlab.crja72.ru/golang/2025/spring/course/projects/go7/marketplace/auth-service/pkg/metric"
	"gitlab.crja72.ru/golang/2025/spring/course/projects/go7/marketplace/auth-service/pkg/oteltrace"
...
func New(ctx context.Context, port, metricsPort string, otlpConfig config.OTLPConfig, log *logger.Logger, service Service) (*Server, error) {
	...
	rbacAuth.RegisterAuthServiceServer(grpcSrv, NewAuthService(service))
