...
import (
	...
	"github.com/ursulgwopp/payment-microservice/pkg/metric"
	"github.com/ursulgwopp/payment-microservice/pkg/oteltrace"
...
func New(ctx context.Context, port, metricsPort string, otlpConfig config.OTLPConfig, log *logger.Logger, service Service) (*Server, error) {
	...
	payment.RegisterPaymentServiceServer(grpcSrv, NewPaymentService(service))
